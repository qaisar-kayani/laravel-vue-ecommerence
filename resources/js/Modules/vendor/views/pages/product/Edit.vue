                    ...
                    >
                        <div class="sa-entity-layout__body">
                            <div class="sa-entity-layout__main">
                                <div class="card">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            >
                                            <textarea
                                                :class="_vClass(_validator.formData,'description')"
                             ...
                             <div class="row">
                                <photo-provider>
                                    <photo-consumer class="col-sm-4" v-for="(item, index) in formData.gallery" :intro="item.images" :key="item.images" :src="showImage(item.images)">
                                        <div class="card w-100 mt-5">
                                            <div class="card-body p-5">
                                                <div class="mb-5"><h2 class="mb-0 fs-exact-18">Image</h2></div>
                                                <div class="border p-4 d-flex justify-content-center">
                                                    <div class="max-w-20x  max-h-20">
                                                       
                                                        <img :src="showImage(item.thumbnail)" class=" h-auto" alt="">
                                                    </div>
                                                </div>
                            ...
                            <div class="sa-entity-layout__sidebar">
                                <div class="card w-100">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="mb-4">
                                             <label class="form-check mb-0" v-if="formData.status=='pending'">
                                                <input
                                                    type="radio"
...
export default {
    ...
    methods: {
        getProduct(id) {
            this.$store.commit('setToast',true)
            this.$store
                .dispatch("getRow", { url: "catalog/product/list/" + id,requesttype:'POST' })
                .then((res) => {
                    if (res.status == 200) {
