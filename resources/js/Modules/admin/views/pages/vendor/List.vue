            ...
            <div class="container">
                <BreadCrumb
                    :pageHeader="{
                        ...
                        currentRouteName: 'vendor-list',
                        nextRouteName: 'vendor-add',
                    ...
                    >
                        <thead>
                            <tr>
                                ...
                                <th class="min-w-20x">Shope Name</th>
                            ...
                            <tr v-for="(item, index) in this.pageData" :key="index">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        >
                                            <li>
                                               <router-link class="dropdown-item" :to="{name:'vendor-edit',params:{shop_id:item.id,vendor_id:item.user_id}}" >Edit</router-link>
                                            </li>
                                            <li>
