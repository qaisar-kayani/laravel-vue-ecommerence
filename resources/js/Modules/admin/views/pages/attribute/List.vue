    ...
    <div id="top" class="sa-app__body">
        <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
            <div class="container">
                <BreadCrumb
                    :pageHeader="{
                        pageHeading: 'Attribute List',
                        currentRouteName: 'attribute-list',
                        nextRouteName: 'attribute-add',
                            ...
                            <tr v-for="(item, index) in this.pageData" :key="index">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        >
                                            <li>
                                               <router-link class="dropdown-item" :to="{name:'attribute-edit',params:{id:item._id}}" >Edit</router-link>
                                            </li>
                                            <li>
