    ...
    <div id="top" class="sa-app__body">
        <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
            <div class="container">
                ...
                />
                <!-- //card  -->
                <form ref="anyName" @submit.prevent="updateCategory" >
                    <div
                        class="
                            sa-entity-layout
                            ...
                            <div class="sa-entity-layout__main">
                                    ...
                                    <div class="card-body p-5">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-sm-6">
                                            ...
                                            >
                                            <treeselect v-if="options.length>0" v-model="formData.parent_id" :multiple="true" :options="options" 
                                               :flat="true"
                                                 :show-count="true"
                                        ...
                                        <div class="mb-4">
                                         ...
                                         <div class="col-sm-6">
                                            ...
                                            <label
                                                ...
                                                >Filters </label
                                            >
                                            <treeselect  v-if="filters.length>0" v-model="formData.categoryFilter" :multiple="true" :options="filters" 
                                               :flat="true"
                                                 :show-count="true"
                                               search-nested
                                ...
                                <!-- images  -->
                                 <div class="card w-100 mt-5 ">
                                  ...
                                  <!-- edit imagers  -->
                                <div class="row">
                                    <div class="col-sm-4" v-if="formData.image">
                                        <div class="card w-100 mt-5">
                                            <div class="card-body p-5">
                                                <div class="mb-5"><h2 class="mb-0 fs-exact-18">Category Image</h2></div>
                                                <div class="border p-4 d-flex justify-content-center">
                                                    <div class="max-w-20x">
                                                        <img :src="showImage(formData.image)" class="w-100 h-auto" width="320" height="320" alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-sm-4" v-if="formData.image">
                                        <div class="card w-100 mt-5">
                                            <div class="card-body p-5">
                                                <div class="mb-5"><h2 class="mb-0 fs-exact-18">Icon Image</h2></div>
                                                <div class="border p-4 d-flex justify-content-center">
                                                    <div class="max-w-20x">
                                                        <img :src="showImage(formData.image)" class="w-100 h-auto" width="320" height="320" alt="">
                                                    </div>
                                    ...
                                    <div class="col-sm-4" v-if="formData.bannerImage">
                                        <div class="card w-100 mt-5">
                                            <div class="card-body p-5">
                                                <div class="mb-5"><h2 class="mb-0 fs-exact-18">Banner Image</h2></div>
                                                <div class="border p-4 d-flex justify-content-center">
                                                    <div class="max-w-20x">
                                                        <img :src="showImage(formData.bannerImage)" class="w-100 h-auto" width="320" height="320" alt="">
                                                    </div>
                                                </div>
                                                <div class="mt-4 mb-n2">
                                                </div>
...
export default {
    ...
    methods: {
        ...
        {   
            ...
            this.$store.dispatch('getRow',{url:'catalog/category/list/'+id}).then((res)=>{
                if (res.status==200) {
                    this.editData=true
                    this.formData=res.data.data
                    if(this.formData.parent_id=='null'){this.formData.parent_id=[]}
                    if(this.formData.categoryFilter=='null'){this.formData.categoryFilter=[]}
        ...
        updateCategory() {
            ...
            if (!this._validator.$error) {
                 this.formData.url='catalog/category/edit/'+this.$route.params.id,
                this.$store
                    .dispatch("saveData", this.formData)
                    .then((res) => {
                        if (res.status == 200) {
                            this.$toast.success("Category successfull Update");
                        }
                    });
            }
        },
        ...
        {  
            if(file){
                ...
                this.formData.new_icon=file[0]
               
            }else
            {
                this.formData.new_icon=null
        ...
        {   
            if(file)
            {
                this.formData.new_image=file[0]
            }else
            {
                this.formData.new_image=null
            }
        ...
        {
            if (file) {
                this.formData.new_bannerImage=file[0]
            }else
            {
                this.formData.new_bannerImage=null
            }
        }
