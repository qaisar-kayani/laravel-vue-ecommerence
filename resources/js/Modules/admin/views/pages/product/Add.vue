                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="invalid-feedback">{{_vErrorMessage(_validator.formData,'name')}}</div>
                                            ...
                                            >
                                            <treeselect required
                                             v-if="vendorList"  v-model="formData.vendor_id" :multiple="false" :options="vendorList"  />
                                             <div class="invalid-feedback">{{_vErrorMessage(_validator.formData,'vendor_id')}}</div>
