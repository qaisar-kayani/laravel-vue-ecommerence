...
<div class="sa-app__sidebar">
    <div class="sa-sidebar">
        <div class="sa-sidebar__header">
            <a class="sa-sidebar__logo" href="javascript::void(0)">
                <!-- logo -->
                <div class="sa-sidebar-logo">
                    ...
                    <img :src="showImage('public/assets/icon/favicon.svg')"  alt="logo" style="Width:120px;height:20px"/>
                ...
                <li class="sa-nav__section">
                    ...
                    <ul class="sa-nav__menu sa-nav__menu--root">
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                           <router-link :to="{name:'dashboard'}"  class="sa-nav__link">
                        ...
                        <li   @click="sideBar($event.target)"
                            class="sa-nav__menu-item sa-nav__menu-item--has-icon " 
                            data-sa-collapse-item="sa-nav__menu-item--open">
                            <a href="javascript:void(0)" class="sa-nav__link" data-sa-collapse-trigger="">
                                <span class="sa-nav__icon">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="1em"
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <router-link :to="{name:'product-list'}" class="sa-nav__link">
                                ...
                                <li class="sa-nav__menu-item">
                                   <router-link :to="{name:'category-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Categories List</span>
                                    </router-link>
                                </li>
                                <li class="sa-nav__menu-item">
                                   <router-link :to="{name:'attribute-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Attributes List</span>
                                    </router-link>
                                </li>
                                <li class="sa-nav__menu-item">
                                   <router-link :to="{name:'attributevalue-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Attributes  Values</span>
                                    </router-link>
                                </li>
                        ...
                        <!-- //vendor -->
                         <li  @click="sideBar($event.target)"
                            ...
                            <a href="javascript:void(0)" class="sa-nav__link" data-sa-collapse-trigger="">
                                ...
                                <span class="sa-nav__title">Vendor Management</span>
                                <span class="sa-nav__arrow">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="6"
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <router-link :to="{name:'vendor-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Vender List</span>
                                  </router-link>
                                </li>
                         ...
                         <li @click="sideBar($event.target)"
                            ...
                            <a href="javascript:void(0)" class="sa-nav__link" data-sa-collapse-trigger="">
                                ...
                                <span class="sa-nav__title">Order LIst</span>
                                <span class="sa-nav__arrow">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="6"
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <router-link :to="{name:'order-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                        ...
                        <li @click="sideBar($event.target)"
                            ...
                            <a href="javascript:void(0)" class="sa-nav__link" data-sa-collapse-trigger="">
                                ...
                                <span class="sa-nav__title">Grouping </span>
                                <span class="sa-nav__arrow">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="6"
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <router-link :to="{name:'group-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Group List</span>
                                  </router-link>
                                </li>
                                 <li class="sa-nav__menu-item">
                                    <router-link :to="{name:'product-group'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">Product Grouping</span>
                                  </router-link>
                                </li>
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <router-link :to="{name:'customer-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                         ...
                         <li @click="sideBar($event.target)"
                            ...
                            <a href="javascript:void(0)" class="sa-nav__link" data-sa-collapse-trigger="">
                                ...
                                <span class="sa-nav__title">CMS</span>
                                <span class="sa-nav__arrow">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="6"
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <router-link :to="{name:'slider-list'}" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
...
export default {
  ...
  methods: {
      sideBar(event)
      {   
          if($(event).closest('li').hasClass('sa-nav__menu-item--open'))
          {
              $(event).closest('li').removeClass('sa-nav__menu-item--open')
          }else
          {
              $(event).closest('li').addClass('sa-nav__menu-item--open')
          }
      },
