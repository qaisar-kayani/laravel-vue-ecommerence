                        ...
                        <div class="sa-toolbar__item sa-toolbar__item--search">
                            <form class="sa-search sa-search--state--pending">
                                <div class="sa-search__body">
                                    ...
                                    <input type="text" id="" class="sa-search__input" placeholder="Search for the truth" autocomplete="off" />
                        ...
                        <div class="dropdown sa-toolbar__item">
                            ...
                            >
                                ...
                                <span class="sa-toolbar-user__info">
                                    <span class="sa-toolbar-user__title"> {{this.$store.getters.getAuth.last_name}}</span>
                                    <span class="sa-toolbar-user__subtitle">{{this.$store.getters.getAuth.email}}</span>
                                </span>
                            </button>
                            <ul class="dropdown-menu w-100 "  :class="{show: isActive}" aria-labelledby="dropdownMenuButton" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(-11px, 53px);" >
                                ...
                                <li><hr class="dropdown-divider" /></li>
                                 <li><a @click="logout" href="javascript:void(0)" class="dropdown-item" >Sign Out</a></li>
                            </ul>
                        </div>
                    </div>
...
export default {
    mounted() {
        // this.body_script("assets/js/stroyka.js");
    },
    data: {
    isActive: false
     },
