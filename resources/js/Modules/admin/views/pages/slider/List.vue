    ...
    <div id="top" class="sa-app__body">
        <div class="mx-sm-2 px-2 px-sm-3 px-xxl-4 pb-6">
            <div class="container">
                <BreadCrumb
                    :pageHeader="{
                        pageHeading: 'slider List',
                        currentRouteName: 'slider-list',
                        nextRouteName: 'slider-add',
                            ...
                            <tr v-for="(item, index) in this.pageData" :key="index">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        >
                                            <li>
                                               <router-link class="dropdown-item" :to="{name:'slider-edit',params:{id:item._id}}" >Edit</router-link>
                                            </li>
                                            <li>
...
export default {
    ...
    methods: {
        getPageData(page=1) {
            ...
            let url='admin/plugins/slider/list';
