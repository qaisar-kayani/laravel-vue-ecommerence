...
<div class="main-container">
    ...
    <div id="content">
        ...
        <div class="container">
           ...
           {{-- //shop by category --}}
           <shop-by-category shop_category="{{$shopByCategory}}"></shop-by-category>
            ...
            <div class="row">
                                                ...
                                                <div class="inner">
                                                    ...
                                                    <div class="item-right col-lg-6 col-md-7 col-sm-7 col-xs-12">
                                                        <div class="caption">
                                                            ...
                                                            <p class="price">   <span class="price-new">AED 60.00</span>
                                                ...
                                                <div class="inner">
                                                    ...
                                                    <div class="item-right col-lg-6 col-md-7 col-sm-7 col-xs-12">
                                                        <div class="caption">
                                                            ...
                                                            <p class="price">   <span class="price-new">AED 80.00</span>
                                                ...
                                                <div class="inner">
                                                    ...
                                                    <div class="item-right col-lg-6 col-md-7 col-sm-7 col-xs-12">
                                                        <div class="caption">
                                                            ...
                                                            <p class="price">   <span class="price-new">AED 70.00</span>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    @php
                        $list=[];
                        foreach ($bestSellerCategory as $key => $value) {
                            # code...
                            $bestSellerCategory[$key]['product']=$value->product;
                        }

                    @endphp


                    <shop-best-sale :bestproduct="{{$bestSellerCategory}}"/>
                            ...
                            <div class="ltabs-wrap">
                                    ...
                                    <span class="ltabs-tab-selected">Bathroom</span> <span class="ltabs-tab-arrow">▼</span>
                                        <div class="item-sub-cat">
                                            ...
                                            <ul class="ltabs-tabs cf">
                                               ...
                                               @endphp
                                                <li class="ltabs-tab {{$class}}"  data-category-id="{{$bestSeller->_id}}" data-active-content=".items-{{$bestSeller->_id}}" > <span  class="ltabs-tab-label">{{$bestSeller->name}}</span> </li>
                                                @endforeach
                                ...
                                <div class="ltabs-items-container products-list grid">
                                 ...
                                 @php
                                   ...
                                   @endphp
                                    <div class="ltabs-items {{$class}}  items-{{$bestSeller->_id}}" data-total="{{count($bestSeller->product)}}">
                                        <div class="ltabs-items-inner ltabs-slider">
                                                    ...
                                                    <div class="product-item-container">
                                                        ...
                                                        <div class="right-block">
                                                            <div class="caption">
                                                                ...
                                                                <div class="price"> <span class="price-new">AED 46.00</span>
                                            ...
                                            @php 
                                            $chunks=array_chunk($bestSeller->product->toArray(),2);
                                            @endphp
                                            ...
                                            <div class="ltabs-item">
                                              @foreach ($chunk as $product )
                                                ...
                                                @php
                                                    ...
                                                    $productImage=isset($product['feature_image'])?$product['feature_image']:"empty";
                                                @endphp
                                                ...
                                                <div class="item-inner product-layout transition product-grid">
                                                    <div class="product-item-container">
                                                        <div class="left-block">
                                                            <div class="product-image-container second_img">
                                                                <a href="product/{{$product['slug']}}/{{$product['_id']}}" target="_self" title="{{$product['name']}}">
                                                                    <img src="{{asset($productImage)}}" class="img-1 img-responsive" alt="image">
                                                                    <img src="{{asset($productImage)}}" class="img-2 img-responsive" alt="image">
                                                                </a>
                                                            </div>
                                                            @if ($product['sale_price']>0)
                                                                @php
                                                                    $dis=$product['regular_price']-$product['sale_price'];
                                                                    $dis=($dis/$product['regular_price'])*100;
                                                                @endphp
                                                            <div class="box-label"> <span class="label-product label-sale"> -{{$dis}}% </span></div>
                                                            @endif
                                                        ...
                                                        <div class="right-block">
                                                            <div class="caption">
                                                                ...
                                                                <h4><a href="product.html" title="{{$product['name']}}" target="_self">{{Str::limit($product['name'], 30)}}</a></h4>
                                                              
                                                                <div class="price"> 
                                                                    @if(isset($product['sale_price']) && $product['sale_price'])
                                                                    <span class="regular_price-new">AED {{$product['regular_price']}}</span>
...
@endsection
{{-- @push('custom_js')
<script type="text/javascript" src="{{ asset('public/js/frontend/home.js') }}"></script>
