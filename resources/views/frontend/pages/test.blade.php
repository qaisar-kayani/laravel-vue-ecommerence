...
<head>
    ...
    <!-- Basic page needs
    ============================================ -->
    <title>Price Driller - Drill the best price in the market!</title>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="header-top-left col-lg-7 col-md-8 col-sm-6 col-xs-4">
                        <div class="hidden-sm hidden-xs welcome-msg"><b>Welcome to Price Driller !</b> ! Wrap new offers / gift every single day on by using our discount coupons. </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="navbar-logo col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <div class="logo"><a href="index.html"><img src="{{asset('public/frontend/image/catalog/logo.svg')}}" height="55%" width="55%" title="Your Store" alt="Your Store" /></a></div>
                    </div>
                    <!-- //end Logo -->
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="row">
                                                                            <div class="col-md-3 img img1">
                                                                                <a href="#"><img src="{{asset('public/frontend/image/catalog/menu/megabanner/image-1.jpg')}}" alt="banner1"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img2">
                                                                                <a href="#"><img src="{{asset('public/frontend/image/catalog/menu/megabanner/image-2.jpg')}}" alt="banner2"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img3">
                                                                                <a href="#"><img src="{{asset('public/frontend/image/catalog/menu/megabanner/image-3.jpg')}}" alt="banner3"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img4">
                                                                                <a href="#"><img src="{{asset('public/frontend/image/catalog/menu/megabanner/image-4.jpg')}}" alt="banner4"></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="container-mega">
                                                    <ul class="megamenu">
                                                        <li class="item-vertical  with-sub-menu hover">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="{{asset('public/frontend/image/catalog/menu/icons/ico10.png')}}" alt="icon">
                                                        ...
                                                        <li class="item-vertical">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="{{asset('public/frontend/image/catalog/menu/icons/ico1.png')}}" alt="icon">
                                                        ...
                                                        <li class="item-vertical  style1 with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                <span class="label"></span>
                                                                <img src="{{asset('public/frontend/image/catalog/menu/icons/ico9.png')}}" alt="icon">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="row banner">
                                                                                <a href="#">
                                                                                    <img src="{{asset('public/frontend/image/catalog/menu/megabanner/vbanner1.jpg')}}" alt="banner1">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <li class="item-vertical with-sub-menu hover">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{asset('public/frontend/image/catalog/menu/icons/ico7.png')}}" alt="icon">
                                                            ...
                                                            <li class="item-vertical css-menu with-sub-menu hover">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                     ...
                                                                     <img src="{{asset('public/frontend/image/catalog/menu/icons/ico6.png')}}" alt="icon">
                                                            ...
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{asset('public/frontend/image/catalog/menu/icons/ico5.png')}}" alt="icon">
                                                                    <span>Health & Beauty</span>
                                                            ...
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{asset('public/frontend/image/catalog/menu/icons/ico4.png')}}" alt="icon">
                                                                    <span>Bathroom</span>
                                                                </a>
                                                            </li>
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{asset('public/frontend/image/catalog/menu/icons/ico3.png')}}" alt="icon">
                                                            ...
                                                            <li class="item-vertical" >
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                    <img src="{{asset('public/frontend/image/catalog/menu/icons/ico2.png')}}" alt="icon">
                                                                    <span>Bedroom</span>
                                                                </a>
                                                            </li>
                                                            <li class="item-vertical" >
                                                            ...
                                                            <li class="item-vertical" style="display: none;">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{asset('public/frontend/image/catalog/menu/icons/ico11.png')}}" alt="icon">
                                                            ...
                                                            <li class="item-vertical" style="display: none;">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{asset('public/frontend/image/catalog/menu/icons/ico12.png')}}" alt="icon">
            ...
            <div class="module sohomepage-slider ">
                <div class="yt-content-slider"  data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column0="1" data-items_column1="1" data-items_column2="1"  data-items_column3="1" data-items_column4="1" data-arrows="no" data-pagination="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                    <div class="yt-content-slide">
                        <a href="#"><img src="{{asset('public/frontend/image/catalog/slideshow/home1/slider-1.jpg')}}" alt="slider1" class="img-responsive"></a>
                    </div>
                    <div class="yt-content-slide">
                        <a href="#"><img src="{{asset('public/frontend/image/catalog/slideshow/home1/slider-2.jpg')}}" alt="slider2" class="img-responsive"></a>
                    </div>
                    <div class="yt-content-slide">
                        <a href="#"><img src="{{asset('public/frontend/image/catalog/slideshow/home1/slider-3.jpg')}}" alt="slider3" class="img-responsive"></a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 main-left sidebar-offcanvas">
                ...
                <div class="module">
                    <div class="banners banners2">
                        <div class="banner">
                            <a href="#"><img src="{{asset('public/frontend/image/catalog/banners/banner4.jpg')}}" alt="image"></a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Mandouille short ">
                                                    <img src="{{asset('public/frontend/image/catalog/demo/product/80/1.jpg')}}" alt="Mandouille short">
                                                    </a>
                                            </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Xancetta bresao ">
                                                        <img src="{{asset('public/frontend/image/catalog/demo/product/80/2.jpg')}}" alt="Xancetta bresao">
                                                        </a>
                                            </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Sausage cowbee ">
                                                            <img src="{{asset('public/frontend/image/catalog/demo/product/80/3.jpg')}}" alt="Sausage cowbee">
                                                            </a>
                                            </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Chicken swinesha ">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/4.jpg')}}" alt="Chicken swinesha">
                                                                </a>
                                            </div>
                                ...
                                <div class="item ">
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                ...
                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/5.jpg')}}" alt="Qeserunt shortloin">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                ...
                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/6.jpg')}}" alt="Consecte quichuck">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            ...
                                            <img src="{{asset('public/frontend/image/catalog/demo/product/80/7.jpg')}}" alt="Neatball bresaola">
                                            </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                ...
                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/8.jpg')}}" alt="Yutculpa ullamco">
                                                </a>
                                            </div>
                ...
                <div class="module">
                    <div class="banners banners4">
                        <div class="banner">
                            <a href="#"><img src="{{asset('public/frontend/image/catalog/banners/banner5.jpg')}}" alt="image"></a>
                        </div>
                    </div>
                </div>
                            ...
                            data-pagination="yes" data-lazyload="yes" data-loop="yes" data-buttonpage="top">
                                <div class="media" > 
                                    <div class="item head-button">
                                            <div class="media-left so-block">
                                                <a href="#" target="_self">
                                                    <img src="{{asset('public/frontend/image/catalog/blog/2.jpg')}}" alt="Duis autem vel eum irure sed diam nonumy">
                                                </a>
                                            </div>
                                ...
                                <div class="media" > 
                                    <div class="item head-button">
                                            <div class="media-left so-block">
                                                <a href="#" target="_self">
                                                    <img src="{{asset('public/frontend/image/catalog/blog/1.jpg')}}" alt="Duis autem vel eum irure sed diam nonumy">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <div class="media-content so-block">
                                ...
                                <div class="item ">
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Mandouille short ">
                                                    <img src="{{asset('public/frontend/image/catalog/demo/product/80/8.jpg')}}" alt="Mandouille short">
                                                    </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Xancetta bresao ">
                                                        <img src="{{asset('public/frontend/image/catalog/demo/product/80/7.jpg')}}" alt="Xancetta bresao">
                                                        </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Sausage cowbee ">
                                                            <img src="{{asset('public/frontend/image/catalog/demo/product/80/6.jpg')}}" alt="Sausage cowbee">
                                                            </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Chicken swinesha ">
                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/5.jpg')}}" alt="Chicken swinesha">
                                                </a>
                                            </div>
                                ...
                                <div class="item ">
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Qeserunt shortloin ">
                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/4.jpg')}}" alt="Qeserunt shortloin">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Consecte quichuck ">
                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/3.jpg')}}" alt="Consecte quichuck">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Neatball bresaola ">
                                            <img src="{{asset('public/frontend/image/catalog/demo/product/80/2.jpg')}}" alt="Neatball bresaola">
                                            </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Yutculpa ullamco ">
                                                <img src="{{asset('public/frontend/image/catalog/demo/product/80/1.jpg')}}" alt="Yutculpa ullamco">
                                                </a>
                                            </div>
                ...
                <div class="module">
                    <div class="banners banners5">
                        <div class="banner">
                            <a href="#"><img src="{{asset('public/frontend/image/catalog/banners/banner6.jpg')}}" alt="image"></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 main-right">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 col3">
                        <div class="modcontent clearfix">
                            <div class="banners banners1"> 
                                <div class="b-img">
                                        <a href="#"><img src="{{asset('public/frontend/image/catalog/banners/banner1.jpg')}}" alt="banner1"></a>
                                </div>
                                <div class="b-img2">
                                        <a href="#"><img src="{{asset('public/frontend/image/catalog/banners/banner2.jpg')}}" alt="banner2"></a>
                                </div>    
                ...
                <div class="banners banners3">
                    <div class="banner">
                        <a href="#">
                            <img src="{{asset('public/frontend/image/catalog/banners/banner3.jpg')}}" alt="image">
                        </a>
                    </div>
                </div>
                                                ...
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image"> 
                                                        ...
                                                        <a href="#" target="_self" title="product">
                                                            <img src="{{asset('public/frontend/image/catalog/demo/product/320/1.jpg')}}" alt="Yutculpa ullamco" class="img-responsive">
                                                        </a>
                                            ...
                                            <div class="inner">
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image"> 
                                                        ...
                                                        <a href="#" target="_self" title="Xancetta bresao">
                                                            <img src="{{asset('public/frontend/image/catalog/demo/product/320/2.jpg')}}" alt="Xancetta bresao" class="img-responsive">
                                                        </a>
                                                        <div class="button-group so-quickview">
                                                ...
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image">
                                                        ...
                                                        <a href="#" target="_self" title="Wamboudin ribeye">
                                                            <img src="{{asset('public/frontend/image/catalog/demo/product/320/3.jpg')}}" alt="Wamboudin ribeye" class="img-responsive">
                                                        </a>
                                                        <div class="button-group so-quickview">
                                                ...
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image">
                                                        ...
                                                        <a href="#" target="_self" title="Proident leerkas">
                                                            <img src="{{asset('public/frontend/image/catalog/demo/product/320/4.jpg')}}" alt="Proident leerkas" class="img-responsive">
                                                        </a>
                                                        <div class="button-group so-quickview">
                ...
                <div class="banners banners6">
                    <div class="banner">
                        <a href="#">
                            <img src="{{asset('public/frontend/image/catalog/banners/banner7.jpg')}}" alt="image">
                        </a>
                    </div>
                </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/1.jpg')}}" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/12.jpg')}}" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Chicken swinesha">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/2.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/11.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/3.jpg')}}" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/10.jpg')}}" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Sausage cowbee">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/4.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/9.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/5.jpg')}}" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/8.jpg')}}" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Balltip nullaelit">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/6.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/7.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Ribeye hamhock">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/7.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/6.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Wamboudin ribeye">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/8.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/5.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Lamboudin ribeye">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/9.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/4.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Ribeye hamhock">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/10.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/3.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-sale"> -7% </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/11.jpg')}}" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/2.jpg')}}" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Balltip nullaelit">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/12.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/1.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                ...
                <div class="banners banners7">
                    <div class="row">
                        <div class="banner1 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="b1">
                                <a href="#">
                                    <img src="{{asset('public/frontend/image/catalog/banners/banner8.jpg')}}" alt="image">
                                </a>
                            </div>
                            <div class="b2">
                                <a href="#">
                                    <img src="{{asset('public/frontend/image/catalog/banners/banner9.jpg')}}" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="banner2 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <a href="#">
                                <img src="{{asset('public/frontend/image/catalog/banners/banner10.jpg')}}" alt="image">
                            </a>
                        </div>
                        <div class="banner3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="b1">
                                <a href="#">
                                    <img src="{{asset('public/frontend/image/catalog/banners/banner11.jpg')}}" alt="image">
                                </a>
                            </div>
                            <div class="b2">
                                <a href="#">
                                    <img src="{{asset('public/frontend/image/catalog/banners/banner12.jpg')}}" alt="image">
                                </a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid first-item">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/funiture/10.jpg')}}" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/funiture/9.jpg')}}" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Chicken swinesha">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/15.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/2.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-sale"> -16% </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/14.jpg')}}" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/3.jpg')}}" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Sausage cowbee">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/13.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/4.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/12.jpg')}}" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/5.jpg')}}" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Balltip nullaelit">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/11.jpg')}}" class="img-1 img-responsive" alt="image">
                                                                <img src="{{asset('public/frontend/image/catalog/demo/product/270/6.jpg')}}" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
...
<!-- //Main Container -->
    ...
    <footer class="footer-container typefooter-1">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col-style">
                        <div class="infos-footer">
                            <a href="#"><img src="{{asset('public/frontend/image/catalog/logo.svg')}}" height="35%" width="35%" alt="image"></a>
                            <ul class="menu">
                                <li class="adres">
                                    Suite 1004, IT Plaza, Silicon Oasis, Dubai, United Arab Emirates
                                </li>
                                <li class="phone">
                                    (+971) 4 1234567 - (+971) 55 1234567
                                </li>
                                <li class="mail">
                                    <a href="mailto:contact@pricedrilller.com">contact@pricedriller.com</a>
                                </li>
                                <li class="time">
                    ...
                    <div class="col-lg-12 col-xs-12 text-center">
                        <img src="{{asset('public/frontend/image/catalog/demo/payment/payment.png')}}" alt="imgpayment">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-bottom ">
            <div class="container">
                <div class="copyright">
                    Price Driller © 2021. All Rights Reserved. Designed by <a href="https://www.onlinist.com" target="_blank">ONLINIST</a>
                </div>
            </div>
        </div>
        <!-- /Footer Bottom Container -->
